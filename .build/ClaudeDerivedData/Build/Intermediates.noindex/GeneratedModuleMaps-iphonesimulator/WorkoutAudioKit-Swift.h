...
#ifndef WORKOUTAUDIOKIT_SWIFT_H
#define WORKOUTAUDIOKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WorkoutAudioKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC15WorkoutAudioKit15AudioCueService")
@interface AudioCueService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVSpeechSynthesizer;
@class AVSpeechUtterance;
@interface AudioCueService (SWIFT_EXTENSION(WorkoutAudioKit)) <AVSpeechSynthesizerDelegate>
